sap.ui.controller("test.resources.newView1", {
	...
	onInit: function() {
		...
		jQuery.sap.require("test.resources.utils.connectivity");
		
		var oModel = new sap.ui.model.odata.ODataModel(serviceUrl,true,"<USER>","<PWD>");
